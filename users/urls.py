...
from .views import AdminUsuariosView, UsuarioListView
from .auth_views import RegistroView, LoginView

app_name = "users"

from .views import AdminUsuariosView, UsuarioListView, EditarPerfilView, EliminarCuentaView, VerPerfilView, TarjetasView, VincularTarjetaView
urlpatterns = [
